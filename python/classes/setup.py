...
setup(
    ...
    description='LivestockGH is a plugin/library for Grasshopper written in Python',
    ...
    packages=find_packages(exclude=['DelphinClasses', 'DelphinGH']),
